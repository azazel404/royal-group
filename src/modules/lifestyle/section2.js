					...
					<div className='flex justify-center items-center mt-8 lg:mt-0 '>
						<div className='lg:max-w-3xl'>
							...
							<p className='text-[14px] lg:text-[20px] xl:text-[22px] 2xl:text-[24px] text-white font-[200] mb-[26px] leading-[160%]'>
								Offering an exclusive and intimate atmosphere accompanied by meticulously curated selections of in-house
								dry-aged and ‘Premium’ cuts. Yen Signature features Japanese wagyu, USDA, and Australian grass-fed
								selections. Every meat has been curated for the best balance between marbling, texture, and flavors.
							</p>
							<p className='text-[14px] lg:text-[20px] xl:text-[22px] 2xl:text-[24px] text-white font-[200] mb-[26px] leading-[160%]'>
